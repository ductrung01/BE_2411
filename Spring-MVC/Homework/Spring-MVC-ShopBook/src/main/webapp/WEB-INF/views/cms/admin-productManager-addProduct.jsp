  ...
  <section class="section-content">
    <div class="container">
      ...
      <main class="add-book-form mb-5">
        <form class="w-50" action="${contextPath}/cms/insert" method="post">
          <div class="mb-3">
            <label for="add-book-title" class="form-label">Tên sách</label>
            <input type="text" class="form-control" name="tenSach" id="add-book-title">
          </div>
          <div class="mb-3">
            <label for="add-book-author" class="form-label">Tác giả</label>
            <input type="text" class="form-control" name="tacGia" id="add-book-author">
          </div>
          <div class="mb-3">
            <label for="add-book-pages" class="form-label">Số trang</label>
            <input type="number" class="form-control" name="soTrang" id="add-book-pages">
          </div>
          <div class="mb-3">
            <label for="add-book-publisher" class="form-label">Nhà xuất bản</label>
            <input type="text" class="form-control" name="nhaXuatBan" id="add-book-publisher">
          </div>
          <div class="mb-3">
            <label for="add-book-category" class="form-label">Thể loại</label>
            <input type="text" class="form-control" name="theLoai" id="add-book-category">
          </div>
          <div class="mb-3">
            <label for="add-book-yearPublishing" class="form-label">Năm phát hành</label>
            <input type="number" class="form-control" name="namXuatBan" id="add-book-yearPublishing">
          </div>
          <div class="mb-3">
            <label for="add-book-yearPublishing" class="form-label">Số lượt mua</label>
            <input type="number" class="form-control" name="soLuotMua" id="add-book-stockQuantity" required>
          </div>
          <div class="mb-3">
            <label for="add-book-price" class="form-label">Giá</label>
            <input type="number" class="form-control" name="gia" id="add-book-price">
          </div>
          <div class="mb-3">
            <label for="add-book-discount" class="form-label">Khuyến mãi</label>
            <input type="number" class="form-control" name="khuyenMai" id="add-book-discount"required>
          </div>

          <div class="mb-3">
            <label for="add-book-quantity" class="form-label">Số lượng trong kho</label>
            <input type="number" class="form-control" name="soLuongTrongKho" id="add-book-quantity" required>
          </div>

          <div class="mb-3">
            <label for="add-book-description" class="form-label">Mô tả</label>
            <textarea class="form-control" name="moTa" id="add-book-description" rows="5"required></textarea>
          </div>
          <div class="mb-3">
            <label for="add-book-imageName" class="form-label">Hình</label>
            <input type="file" class="form-control"  id="add-book-imageName" name="hinhAnh"required>
          </div>
