...
<section class="section-content">
    <div class="container">
        ...
        <main class="add-book-form mb-5">
            <form class="w-50" action="${pageContext.request.contextPath}cms/edit-book" method="post">
                <div class="mb-3">
                    <label for="add-book-title" class="form-label">ID Sách</label>
                    <input type="text" class="form-control" value="${product.id}" name="idSach" id="add-id-title" required readonly>
                </div>
                <div class="mb-3">
                    <label for="add-book-title" class="form-label">Tên sách</label>
                    <input type="text" class="form-control" value="${product.bookTitle}" name="tenSach" id="add-book-title">
                </div>
                <div class="mb-3">
                    <label for="add-book-author" class="form-label">Tác giả</label>
                    <input type="text" class="form-control" value="${product.author}"  name="tacGia" id="add-book-author">
                </div>
                <div class="mb-3">
                    <label for="add-book-pages" class="form-label">Số trang</label>
                    <input type="number" class="form-control" value="${product.pageCount}" name="soTrang" id="add-book-pages">
                </div>
                <div class="mb-3">
                    <label for="add-book-publisher" class="form-label">Nhà xuất bản</label>
                    <input type="text" class="form-control" value="${product.publisher}" name="nhaXuatBan" id="add-book-publisher">
                </div>
                <div class="mb-3">
                    <label for="add-book-category" class="form-label">Thể loại</label>
                    <input type="text" class="form-control" value="${product.genre}"  name="theLoai" id="add-book-category">
                </div>
                <div class="mb-3">
                    <label for="add-book-yearPublishing" class="form-label">Năm phát hành</label>
                    <input type="number" class="form-control" value="${product.publicationYear}"  name="namXuatBan" id="add-book-yearPublishing">
                </div>
                <div class="mb-3">
                    <label for="add-book-yearPublishing" class="form-label">Số lượt mua</label>
                    <input type="number" class="form-control" value="${product.stockQuantity}" name="soLuotMua" id="add-book-stockQuantity" required>
                </div>
                <div class="mb-3">
                    <label for="add-book-price" class="form-label">Giá</label>
                    <input type="number" class="form-control" value="${product.price}" name="gia" id="add-book-price">
                </div>
                <div class="mb-3">
                    <label for="add-book-discount" class="form-label">Khuyến mãi</label>
                    <input type="number" class="form-control" value="${product.discount}" name="khuyenMai" id="add-book-discount"required>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <textarea class="form-control" name="moTa" id="add-book-description" rows="5" required>${product.description}</textarea>
                </div>
                <div class="mb-3">
                    <label for="add-book-imageName" class="form-label">Hình</label>
                    <input type="file" class="form-control" value="${product.image}" id="add-book-imageName" name="hinhAnh"required>
                </div>
