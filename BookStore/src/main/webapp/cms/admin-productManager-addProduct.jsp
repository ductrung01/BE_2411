...
<section class="section-content">
    <div class="container">
        ...
        <main class="add-book-form mb-5">
            <form class="w-50" action="${pageContext.request.contextPath}/cms/insert-book" method="post">
                <div class="mb-3">
                    <label for="add-book-title" class="form-label">Tên sách</label>
                    <input type="text" class="form-control" name="tenSach" id="add-book-title" required>
                </div>
                <div class="mb-3">
                    <label for="add-book-author" class="form-label">Tác giả</label>
                    <input type="text" class="form-control" name="tacGia" id="add-book-author"required>
                </div>
                <div class="mb-3">
                    <label for="add-book-pages" class="form-label">Số trang</label>
                    <input type="number" class="form-control" name="soTrang" id="add-book-pages"required>
                </div>
                <div class="mb-3">
                    <label for="add-book-publisher" class="form-label">Nhà xuất bản</label>
                    <input type="text" class="form-control" name="nhaXuatBan" id="add-book-publisher"required>
                </div>
                <div class="mb-3">
                    <label for="add-book-yearPublishing" class="form-label">Năm phát hành</label>
                    <input type="number" class="form-control" name="namXuatBan" id="add-book-yearPublishing"required>
                </div>

                <div class="mb-3">
                    <label for="add-book-price" class="form-label">Giá</label>
                    <input type="number" class="form-control" name="gia" id="add-book-price"required>
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <input type="number" class="form-control" name="tonKho" id="add-book-quantity"required>
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <input type="number" class="form-control" name="tongSoLuotMua" id="totalBuy"required>
                </div>
