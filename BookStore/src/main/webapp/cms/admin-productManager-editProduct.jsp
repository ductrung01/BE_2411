...
<section class="section-content">
    <div class="container">
        ...
        <main class="add-book-form mb-5">
            <form class="w-50" action="${pageContext.request.contextPath}/update-book" method="post">
                <div class="mb-3">
                    <label for="add-book-title" class="form-label">ID Sách</label>
                    <input type="text" class="form-control" value="${book.idSach}" name="idSach" id="add-id-title" required readonly>
                </div>
                <div class="mb-3">
                    <label for="add-book-title" class="form-label">Tên sách</label>
                    <input type="text" class="form-control" value="${book.tenSach}" name="tenSach" id="add-book-title" required>
                </div>
                <div class="mb-3">
                    <label for="add-book-author" class="form-label">Tác giả</label>
                    <input type="text" class="form-control" name="tacGia" value="${book.tacGia}" id="add-book-author"required>
                </div>
                <div class="mb-3">
                    <label for="add-book-pages" class="form-label">Số trang</label>
                    <input type="number" class="form-control" name="soTrang" value="${book.soTrang}" id="add-book-pages"required>
                </div>
                <div class="mb-3">
                    <label for="add-book-publisher" class="form-label">Nhà xuất bản</label>
                    <input type="text" class="form-control" name="nhaXuatBan" value="${book.nhaXuatBan}" id="add-book-publisher"required>
                </div>
                <div class="mb-3">
                    <label for="add-book-yearPublishing" class="form-label">Năm phát hành</label>
                    <input type="number" class="form-control" name="namXuatBan" value="${book.namXuatBan}" id="add-book-yearPublishing"required>
                </div>

                <div class="mb-3">
                    <label for="add-book-price" class="form-label">Giá</label>
                    <input type="number" class="form-control" name="gia" value="${book.gia}" id="add-book-price"required>
                </div>
                <div class="mb-3">
                    <label for="add-book-discount" class="form-label">Khuyến mãi</label>
                    <input type="number" class="form-control" name="khuyenMai" value="${book.giamGia}" id="add-book-discount"required>
                </div>
                <div class="mb-3">
                    <label for="add-book-quantity" class="form-label">Số lượng trong kho</label>
                    <input type="number" class="form-control" name="tonKho" value="${book.soLuongTonKho}" id="add-book-quantity"required>
                </div>
                <div class="mb-3">
                    <label for="add-book-description" class="form-label">Mô tả</label>
                    <textarea class="form-control" name="moTa"  id="add-book-description"${book.moTa != null ? book.moTa : ''}  rows="5"required></textarea>
                </div>
                <div class="mb-3">
                    <label for="add-book-imageName" class="form-label">Hình</label>
                    <input type="file" class="form-control"  id="add-book-imageName" value="${book.hinhAnh}" name="hinhAnh"required>
                </div>
                <div class="mb-3">
                    <label for="add-book-quantity" class="form-label">Tổng số lượt mua</label>
                    <input type="number" class="form-control" name="tongSoLuotMua" value="${book.tongSoLuotMua}" id="totalBuy"required>
                </div>
