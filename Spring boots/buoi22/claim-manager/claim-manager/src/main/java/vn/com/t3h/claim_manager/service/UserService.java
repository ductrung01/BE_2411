...
//   Respond< UserDTO> saveUser(UserDTO userDTO);
  BaseResponse< List<UserDTO>> findAll(String code, LocalDate fromDate, LocalDate toDate, String phone, Pageable pageable);
}
