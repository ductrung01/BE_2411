...
//    @GetMapping()
//    public ResponseEntity<Respond<List<ClaimDTO>>>getListClaim(
...
//            Pageable pageable
//    ){
//        Respond<List<ClaimDTO>> respond = claimService.getClaims(claimCode,fromDate,toDate,codeStatus,pageable);
//        return ResponseEntity.ok(respond);
//    }
//    @GetMapping("/{id}")
//    public ResponseEntity<List<ClaimDetailDTO>> getDetailClaimById(@PathVariable Long id){
//        List<ClaimDetailDTO> claimDetailDTOS = claimService.getDetailClaimById(id);
//        return ResponseEntity.ok(claimDetailDTOS);
//    }
//}
