...
<div class="container">
    ...
    <form action="table-insert-employee" method="get">
            ...
            <tr>
                ...
                <td>
                    <div class="btn-group" role="group">
                        <a href="delete-employee?id=${employeeModel.id}" class="btn btn-outline-danger">Xóa</a>
                        <a href="edit-employee?id=${employeeModel.id}" class="btn btn-outline-warning">Chỉnh sửa</a>
                    </div>
                </td>
            </tr>
        </c:forEach>
